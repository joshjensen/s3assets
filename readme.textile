...
Helps manage asset caching and storage on S3, by John Jensen <a href="http://joshjensen.com">joshjensen.com</a>
...
To use the Amazon s3 service be sure to setup an s3 account. Once you do, place these lines in your config.php file. Make sure you replace the text with your keys.
